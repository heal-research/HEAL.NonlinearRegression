...
Optimized: ((x0 / (0.064121 + x0)) * 212.68)
";
...
Optimized: Logistic(((((((1.3838 * BI_RADS) + (0.048483 * Age)) + (0.5243 * Shape)) + (0.35251 * Margin)) + (-0.068485 * Density)) + -11.181))
";
...
1.0000e+000,6,8.0870e+002,0.0000e+000,8.6679e+002,0.0000e+000,Logistic(((((((1.3838 * BI_RADS) + (0.048483 * Age)) + (0.5243 * Shape)) + (0.35251 * Margin)) + (-0.068485 * Density)) + -11.181))
1.0001e+000,5,8.0469e+002,-4.0165e+000,8.5314e+002,-1.3655e+001,Logistic((((((Age * 0.048493) + (Shape * 0.5248)) + (Margin * 0.35034)) + (BI_RADS * 1.3823)) + -11.369))
";
